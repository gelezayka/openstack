...
class Params extends AbstractParams
{
    ...
    public function multiattach(): array
    {
        return [
            'type'        => self::BOOL_TYPE,
            'location'    => self::JSON,
            'description' => 'To enable this volume to attach to more than one server, set this value to true. Default is false.',
        ];
    }
    ...
    public function consistencygroupId(): array
    {
        return [
            'type'        => self::STRING_TYPE,
            'location'    => self::JSON,
            'sentAs'      => 'consistencygroup_id',
    ...
    public function sourceReplica(): array
    {
        return [
            'type'        => self::STRING_TYPE,
            'location'    => self::JSON,
            'sentAs'      => 'source_replica',
            'description' => 'source_replica UUID.',
        ];
    }
